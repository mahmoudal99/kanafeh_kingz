    ...
    return MultiProvider(
      providers: [
        ...
        StreamProvider<Profit>.value(
          value: cloudFirestore.streamProfit(today),
        )
      ],
      child: MaterialApp(
        title: 'Kanafeh Kings',
...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [Padding(
          ...
          child: Center(child: Text("Total: " + profit.profit, style: TextStyle(color: Colors.white),)),
        )],
      ),
  ...
  _pickDate() async {
    ...
    if (dateTime != null) {
      ...
      widget.function(pickedDate.day.toString());
    }
  }
}
